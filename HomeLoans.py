...
# Page Title
st.write("# AWS Home Loan Calculator")
...
loan_amount = st.sidebar.number_input("Loan Amount ($)", value=1000000, step=1000)
...
new_payment_sentence = f"💡: Based on your loan changes, the new monthly payment is estimated at **${results['new_total_payment']:,.2f}** with a {savings_or_cost} of **{results['payment_difference']:,.2f}** and an updated loan term of **{Updated_Loan_Term:.1f} years**."
